...
/*
 * This function goes through all the nodes in the graph generated by the parser
 * and prints out the name, type, predecessors, successors, matching, dominator
 * values for that node in the graph.
 *
 */
