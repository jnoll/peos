...
int modelcount = 0;
	...
	if (modelcount == 0) ret_value = add_message(ret_value,"None.\n\n");
	return(ret_value);
}
...
int taskcount = 0;
	...
	if (taskcount == 0) ret_value = add_message(ret_value,"None.\n\n");
	return(ret_value);
}
