...
//
    ...
    /**
     *  Constructs a default PEOSTableModel which is a table of
     *  zero columns and zero rows.
     */
    public PEOSTableModel() {
        this((Vector)null, 0);
    }

    /**
     *  Constructs a PEOSTableModel with <i>numRows</i> and
     ...
     * @see #setValueAt
     */
    public PEOSTableModel(int numRows, int numColumns) {
    ...
    /**
     *  Constructs a PEOSTableModel with as many columns as there are
     ...
     * @see #setValueAt
     */
    public PEOSTableModel(Vector columnNames, int numRows) {
     ...
     * @see #setValueAt
     */
    public PEOSTableModel(Object[] columnNames, int numRows) {
        this(convertToVector(columnNames), numRows);
    }

    /**
     *  Constructs a PEOSTableModel and initializes the table
     ...
     * @see #setDataVector
     */
    public PEOSTableModel(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public PEOSTableModel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
