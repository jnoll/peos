...
</p><p>The initial page (``Active Processes'') shows all of your pending tasks, 
...
</p><p> The left pane of this ``action detail'' page lists all of the tasks to
...
</p><p> The START button allows you to notify PEOS that you are about to begin
...
</p><p> The FINISH button lets you notify PEOS that you have completed the task.
...
be set to ``PENDING.''
</p><p> After you have FINISHed the last task in the process, if it's state becomes
