...
#proc ::dynamicWidgets::getFieldData {pList} {
#       set len [llength $plist]
#
#       for {set i 0} {$i < $len} {incr i} {
#               set temp [lindex $plist $i]
...
#       set inputList [list SingleListbox .right.lbox]
...
proc ::dynamicWidgets::makeAction {} {
        ...
        if {$::uiValues::actionType == "Executable"} {
                ...
                place .right.lower.lblScript -relx 0.55 -rely 0.05
                place .right.lower.script -relx 0.55 -rely 0.27
                place .right.lower.bScript -relx 0.55 -rely 0.55 -width 70 -height 30
        }
