...
{	
	...
	sampleSeekFile = fopen ( "testSeek.dat", "r" ) ;
	testSeekQuery = fopen ( "testSeekQuery.dat", "w" ) ;
	...
	testInputSeek = fopen ( "testSeekQuery.dat", "r" ) ;
	...
	expectedResultSeekFile = fopen ( "expectedResultSeek.txt", "w" ) ;	
