 ...
 * implements many, non-view, default application behaviors such as menus, 
 * file IO, and so forth
                                                  ...
                                                  ActionListener
{
    ...
    public JMainFrame()
    {
        /* Call the base class and pass the new frame title along.In this case 
         * it's the applcation name - note that the title should change to 
	...
	// Add the menu bar to which all menus will be attached
        ...
        JSplitPane sp = new JSplitPane( JSplitPane.HORIZONTAL_SPLIT, jt,
                        m_DataView );
...
*****/        
    ...
    public void fileOpen()
    {
        ...
        // in my swing version right now chooser.setFileFilter( new 
        // ExtensionFileFilter( "pmd", "PML Model Files" ) );
     ...
     * presents
     * the SaveAs chooser dialog if the parameter flag is set, or if the model 
     * is unnamed
