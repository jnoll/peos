                                                  ...
                                                  ActionListener
{
    ...
    public JMainFrame()
    {
        // Call the base class and pass the new frame title along.  
        // In this case it's the applcation name - note that the title should
        // change to reflect the currently open filename which is handled by 
        // the DataView
        super( "" );
...
*****/        
    ...
    public void fileOpen()
    {
        ...
        JPMLDataModel DataModel = null;   // Storage for the DataModel we are 
                                          // supposedly reading
        ...
        // if we get here and the data model is valid then we just loaded a 
        // valid filename
        if ( DataModel == null )
            return;
