 ...
 * multiple view objects to attach to the document and modify/update the document
 * simultaneously.  Further a view can lock the document while it renders the graph
 * to prevent corruption and rendering problems.  
 *
 ...
 *
 */
public class JPMLDataModel extends pml.datamodel.JDataModel implements java.io.Serializable 
{
    // Public methods
     ...
     *
     * @return String containing the PML source representation of the modeled process
     */
    public String toPML()
    {
