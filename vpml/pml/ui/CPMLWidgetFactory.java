...
/**
 * This class provides PML widget creation for insertion into the main view window
 * of the application
 *
...
{
    // Declare border enumerations - it's a shame java doesn't have a non-object based
    // enumeration mecanism
	 ...
	 */
	static public JLabel createPMLWidget( String SymbolName, 
										  Icon icon, 
										  int BorderStyle, 
										  float Alignment )
	{
	    ...
	    switch ( BorderStyle )
	    {
	        ...
	        label.setBorder( new CompoundBorder
	                            ( new CompoundBorder( new LineBorder( Color.black, 2 ),
