 ...
 * updating and displaying PML code.  This class would probably be better made into
 * a base TreeView class and then we derive a specific PML version from it.  But for now
 * we've kind of kluged this together so we have something to show
 *
 * @author Matt Osminer
 * @author Xing Wei
 *
 */
 ...
 public class JPMLTreeView extends JDataView
 {
     ...
     *
     * @param DataModel Reference to the data model from which this view gets it's data
    ...
    public JPMLTreeView( JPMLDataModel DataModel, JFrame ParentFrame )
    {
		...
		m_Tree = new JTree( new DefaultMutableTreeNode( ((JPMLDataModel)getDataModel()).getFocusNode().getSymbolName() ) );
