...
/**
 * This class implements an extended menu class to simplify menu creation and
 * removal you should be able to feed strings into the constructor of this 
 * class and have functonal menus pop out.
 *
...
public class JMenuEx extends javax.swing.JMenu
{
     ...
     * @param MenuLabel String description of the menu. This string appears 
     * on the MenuBar
     ...
     * @param Accelerators list of accelerator keys.  Each key is associated 
     * with the Keymodifiers
     * @param KeyModifiers list of key modifiers (see Keystroke)
     * Note that you can use the string "<separator>" in the MenuItems 
     * argument to insert 
     * separators.  If you don't want an accelerator or short cut key insert 
     * a 0 in place of any character and it will be ignored
     */
     ...
     * location
     * @param ml Reference to a menu listener that wants menu events
     * (can be null)
